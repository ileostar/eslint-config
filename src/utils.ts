...
const isCwdInScope = isPackageExists('@ileostar/eslint-config')
 ...
 * @example
 * ```ts
 * import { renameRules } from '@ileostar/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@ileostar/eslint-config'
