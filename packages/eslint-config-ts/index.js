...
const basic = require('@ileostar/eslint-config-basic')
...
module.exports = {
  ...
  rules: {
    ...
    // ileostar
    'ileostar/generic-spacing': 'error',
    'ileostar/no-cjs-exports': 'error',
    'ileostar/no-ts-export-equal': 'error',
    'ileostar/no-const-enum': 'error',
    'ileostar/named-tuple-spacing': 'error',
