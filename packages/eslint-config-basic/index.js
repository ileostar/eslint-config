...
module.exports = {
  ...
  overrides: [
    ...
    },
    {
      ...
      rules: {
        ...
        'ileostar/no-cjs-exports': 'off',
        'ileostar/no-ts-export-equal': 'off',
  ...
  rules: {
    ...
    // ileostar
    'ileostar/no-import-node-modules-by-path': 'error',
    'ileostar/if-newline': 'error',
    'ileostar/import-dedupe': 'error',
    'ileostar/top-level-function': 'error',
  },
}
